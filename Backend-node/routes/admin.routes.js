...
router.post('/seo-meta', requirePermission('seo.manage'), asyncHandler(controller.saveSeoMeta));
router.put('/seo-meta', requirePermission('seo.manage'), asyncHandler(controller.saveSeoMeta));
...
router.post('/bookings/:bookingId/feedback-link', requirePermission('bookings.view'), asyncHandler(controller.sendFeedbackLink));
