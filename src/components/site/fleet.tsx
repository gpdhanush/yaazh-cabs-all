  ...
  return (
    <section id="fleet" className="py-16 md:py-28">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <p className="text-[10px] uppercase tracking-[0.28em] text-primary sm:text-[11px]">The fleet</p>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {vehicles.map((v) => (
            <article
              key={v.id}
              className="h-full rounded-2xl border border-border bg-card/70 p-5 hover:border-primary/40"
            >
              <div className="h-36 overflow-hidden rounded-xl bg-surface-2/50 sm:h-40">
                <img
                  src={v.image}
