          ...
          {services.map((s) => {
            ...
            return (
              <StaggerItem key={s.title}>
                <article className="h-full rounded-2xl border border-border bg-card/70 p-6 transition-transform duration-300 hover:-translate-y-1 hover:border-brand/40 hover:shadow-[0_18px_40px_-24px_rgba(17,24,39,0.35)]">
