...
const transitions: Record<BookingStatus, BookingStatus[]> = {
  ...
  driver_assigned: ["on_the_way", "driver_assigned", "completed", "cancelled", "no_show"],
  on_the_way: ["arrived", "driver_assigned", "completed", "cancelled", "no_show"],
  arrived: ["trip_started", "driver_assigned", "completed", "cancelled", "no_show"],
